...
# example:
# ./database-rebuild-all.sh sql-attractions sqlserver docker dbo ../AppWebApi
# ./database-rebuild-all.sh sql-attractions sqlserver docker dbo ../AppRazor
# ./database-rebuild-all.sh sql-attractions sqlserver docker dbo ../AppMvc
